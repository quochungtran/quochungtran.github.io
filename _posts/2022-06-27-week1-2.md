...
In the first weeks, for each test case, I will try to :
...
This blog is accompagied by my [github resposiory](https://github.com/quochungtran/Gsoc2022-tesseract-ocr) that containes the source code.
