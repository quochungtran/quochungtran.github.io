...
To facilitate and differentiate between each mode and ignoring another, I would like to divide each way in terms of the type of document.
...
- Mode 6 is helpful for pages of text whose a single font, such as books, novels, or emails…
